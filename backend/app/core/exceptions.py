...
class RoonServiceException(HTTPException):
    """Exception levée par le service Roon."""
    def __init__(self, message: str, status_code: int = status.HTTP_503_SERVICE_UNAVAILABLE):
        super().__init__(status_code=status_code, detail=f"Service Roon indisponible: {message}")
